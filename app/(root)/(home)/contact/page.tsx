	...
	return (
		<div className="py-20">
			<div className="flex justify-center items-center flex-col w-full py-24">
				<div className="my-6">
					<div className="max-w-6xl mx-auto bg-[#000] sm:rounded-lg">
						<div className="grid md:grid-cols-2 items-center gap-16 sm:p-16 p-10 font-[sans-serif]">
							<div>
								...
								<ul className="mt-12 space-y-4">
									<li className="flex items-center">
										...
										<Link
											href="mail:support@whoisfde.com"
											className="text-white text-sm ml-3"
										>
											<strong>support@whoisfde.com</strong>
										</Link>
									</li>
									<li className="flex items-center">
										<svg
								...
								<ul className="flex mt-12 space-x-4">
									<li className="bg-neutral-700 hover:bg-[#94a3b8] h-10 w-10 rounded-full flex items-center justify-center shrink-0">
