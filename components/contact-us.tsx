...
import ContactAnimator from "./util/contact-animator";
  ...
  return (
    <div className="w-full bg-black text-white flex justify-center items-center">
      <div
        ...
        items-center"
      >
        <ContactAnimator root={root!.current}>
          <div className="">
            ...
            <div className="flex flex-col md:flex-row gap-8 md:gap-16">
              <div className="flex flex-col gap-8 justify-center items-start text-white">
                ...
                <div className="flex items-center gap-3">
                  <div>
                    <input type="checkbox"  defaultChecked className="checked:bg-white rounded-full accent-black"/>
                  </div>
