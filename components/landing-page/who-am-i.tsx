              ...
              <div className="flex-1 flex flex-col md:flex-row gap-10 justify-center items-center">
                ...
                <div className="flex-1 flex flex-col gap-4">
                  ...
                  <div className="leading-loose">
                    ...
                    odio sit duis. Habitant nisi amet pellentesque diam nibh risus nibh viverra.
                    Ullamcorper sociis pharetra sagittis pretium quis pretium et ipsum mauris. Quam
                    nunc arcu non integer. Felis amet facilisi nibh elit lectus in in leo.
                    Sollicitudin purus tortor
                  </div>
